...
public class StringTest {
	public static void main(String[] args) {
		...
		// 문자열 비교
		if(str1 == str2) {
			System.out.println("str1, str2의 주소가 같다.");
		} else {
			System.out.println("str1, str2의 주소가 다르다.");
		}
		
		if(str1.equals(str2)) {
			System.out.println("str1, str2의 문자열 값이 같다.");
		} else {
			System.out.println("str1, str2의 문자열 값이 다르다.");
		}
